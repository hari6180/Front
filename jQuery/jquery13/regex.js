...
var regex = {
    ...
    check: function (selector, min, msg) {
        // 대상요소의 선택된 항목수가 주어진 min 값보다 작다면?
    ...
    check: function (selector, max, msg) {
        // 대상요소의 선택된 항목수가 주어진 max 값보다 크다면?
     ...
     * @param {string} selector   검사대상의 css셀렉터
     * @param {string} msg        검사에 실패한 경우 표시할 메시지
     * @param {object} regex_expr 검사할 정규표현식
     * @return 표현식을 충족할 경우 true / 그렇지 않은 경우 false
     */
    ...
    /**
     * 핸드폰 번호 형식과 집전화번호 형식 둘중 하나를 충족하는지 검사한다.
     * @param {string} selector   검사대상의 css셀렉터
     * @param {string} msg        검사에 실패한 경우 표시할 메시지
     * @return 조건에 충족할 경우 true / 그렇지 않은 경우 false
     */
